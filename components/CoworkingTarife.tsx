...
const tarife = [
  { id: 'tagespass', label: 'Tagespass', price: 'EUR 25,-', sub: 'pro Tag, zzgl. MwSt.', info: 'Starttermin frei wählbar — Sofortstart möglich', badge: '−16%' },
  { id: 'zehnerkarte', label: '10er-Karte', price: 'EUR 209,-', sub: 'zzgl. MwSt.', info: '10 Tage Coworking an flexibel wählbaren Tagen', badge: '−16%' },
  { id: 'monatspass', label: 'Monatspass', price: 'EUR 219,-', sub: 'pro Monat, zzgl. MwSt.', info: 'Ein Monat ohne Kündigungsfrist', badge: '−16%' },
  { id: 'monatsabo', label: 'Monatsabo', price: 'EUR 199,-', sub: 'pro Monat, zzgl. MwSt.', info: 'Monatspass mit 3 Monaten Kündigungsfrist', badge: '−16%' },
];
